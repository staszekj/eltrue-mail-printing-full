...
export const fetchPrintedMailsAsyncAction = createAsyncAction(
  "printed-mails/REQUEST",
  "printed-mails/SUCCESS",
  "printed-mails/FAILURE",
  "printed-mails/CANCEL"
)<{}, TPrintedMailsResponse, {}, {}>();
